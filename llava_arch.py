...
from .multimodal_encoder.builder import build_vision_tower,build_ecg_tower
from .multimodal_projector.builder import build_vision_projector,build_ecg_projector
...
class LlavaMetaForCausalLM(ABC):
    ...
    def encode_ecg(self, ecg_wave):
        ...
        projected_token_emb = self.get_model().ecg_projector(token_emb)
        return projected_token_emb
    ...
    ecg_wave  # shape: [B, 12, 5000] 或你的实际输入
        ...
        """
        ecg_tower = self.get_ecg_tower()
        if ecg_tower is None or ecg_waves is None or input_ids.shape[1] == 1:
